-- El RAG solo debe basarse en la "Fuente de conocimiento" (category = 'knowledge').
-- Los "Documentos subidos" (category = 'upload', p.ej. una factura subida en una
-- conversación) quedan fuera de la recuperación hasta que se muevan a conocimiento.
